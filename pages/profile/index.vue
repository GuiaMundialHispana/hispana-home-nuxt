    ...
    <div class="xl:container mx-auto lg:px-16 md:px-8 px-4">
      <div class="profile-wrapper">
        ...
        <figure class="profile-image overflow-hidden" v-else>
          <img v-if="user.userData.profile_pic != null" :src="`https://hispana-autos-3284x.ondigitalocean.app/hispana-home-api${user.userData.profile_pic}`" :alt="user.userData.name">
          <!--  -->
