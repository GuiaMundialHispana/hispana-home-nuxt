<template>
  <section class="w-full md:h-[450px] lg:h-[500px] relative pt-6 sm:pt-16 md:pt-20 mx-auto mb-[50px] border-b border-gray-300 flex items-center justify-start ">
  ...
  <OrganismExclusiveProperties  class="mb-20"/>
</template>