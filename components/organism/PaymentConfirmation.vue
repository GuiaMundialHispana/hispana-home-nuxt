<template>
  <div class="absolute z-40 p-4 w-80 sm:w-96 md:w-[675px] h-96 bg-neutral-white top-1/4 left-1/2 -translate-x-2/4 flex items-center justify-center flex-col rounded-md">
    ...
    <h2 class="md:whitespace-nowrap text-blue-100 font-bold mb-5 md:mb-7 md:text-4xl text-center sm:leading-10">Pago realizado <span class="text-primary-100 ">exitosamente.</span></h2>
