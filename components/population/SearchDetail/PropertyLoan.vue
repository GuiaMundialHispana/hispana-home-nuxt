...
.form-control {
  @apply flex-grow border-2 border-[#ECECEC] flex items-center rounded-tl-lg rounded-bl-lg pl-2.5 text-sm text-neutral-black h-10 font-medium focus:outline-primary-90;
