<template>
  <form @submit.prevent="onSubmit" class="flex flex-col w-full items-center justify-center">
    ...
    <NuxtLink to="/forgotPassword" @click="$emit('close')" class="text-primary-100 ml-auto w-max block underline">Olvidé la contraseña</NuxtLink>
...
.error {
  @apply text-primary-100 text-sm mb-2 text-left ml-2 block font-medium;
}
</style>